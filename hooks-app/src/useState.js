 ...
 * 
 * useEffect
 * Cada vez queramos generar un efecto lateral (actualizar dom, escribir o leer db)
 * Cada vez que queramos generar algo que afecte el uso de nuestro componente se utiliza useEffect
 */
